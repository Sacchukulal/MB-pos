 ...
 */
export type CashPositionView = { openingFloat: MoneyView, cashSales: MoneyView, topUps: MoneyView, cashExpenses: MoneyView, payouts: MoneyView, bankDrops: MoneyView, suppliersPaid: MoneyView, expected: MoneyView, 
/**
