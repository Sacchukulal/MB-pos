...
/// The shared secret. See the module note about what this does not protect. The support tool
/// (`MB-backend/tools/emergency-code.mjs`) holds the same bytes; the two change together.
const SUPPORT_SECRET: [u8; 32] = [
    0x29, 0x56, 0xcf, 0xd3, 0x0d, 0x6c, 0xd5, 0x4a, 0x0c, 0xc5, 0xe9, 0x79, 0xd0, 0xfd, 0x30, 0xa7,
    0x6a, 0x5a, 0x6e, 0x24, 0xf1, 0x91, 0xf7, 0x1e, 0xa5, 0xd6, 0x7e, 0x62, 0xa0, 0xfb, 0xdd, 0x70,
];
